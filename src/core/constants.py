...
REPUESTOS_SORT_COLS = ["Familia", "Articulo"]
REPUESTOS_COLS = ["Familia", "Articulo", "Nombre"]
REPUESTOS_PK_COLS = tuple(REPUESTOS_SORT_COLS)
...
TIPOS_REPUESTOS = {
    ...
    "VIDRIOS": ["VIDRIO", "LUNETA", "PARABRISA", "VIDRO", "ESPEJO"],
    "EXTREMOS": ["EXTREMO"],
    "BAGUETAS": ["BAGUETA"],
    "FERRETERIA": [
        "TORNILLO",
    ...
    "AIRE ACONDICIONADO": ["A/A", "COMPRESOR A/A", "CIGUEÐAL COMPRESOR A/A", ""],
    "PARAGOLPES": ["PARAGOLPE"],
    "FLEXIBLES": ["FLEXIBLE"],
    "TENSORES": ["TENSOR"],
    "JUNTAS": ["JUNTA"],
    "TAPAS": ["TAPA", "TAPON", "TAPITA"],
    "BARRAS DIRECCION": ["BARRA DIRECCION"],
    "TAPIZADOS": ["TAPIZADO"],
    "MASCARAS": ["MASCARA"],
    "CRUCETAS": ["CRUCETA", "CRUZETA"],
    "CAJAS DIRECCION": ["CAJA DIRECCION"],
    "SOPORTES": ["SOPORTE"],
    "RETENES": ["RETEN"],
    "PISTONES": ["PISTON"],
    "FRENOS": ["PASTILLA", "FRENO", "DISCO FRENO"],
    "EMBRAGUES": ["EMBRAGUE", "EMBRIAGUE"],
    "ESTERILLADOS": ["ESTERILLADO"],
    "CALCOS": ["CALCO"],
    "CARTELES": ["CARTEL"],
    "TIRAFONDOS": ["TIRAFONDO"],
    "BUJES": ["BUJE"],
    "BASES ASIENTO": ["BASE ASIENTO"],
    "CAÑOS": ["CAÐO", "CAÑO"],
    "COLUMNAS DE DIRECCION": ["COLUMNA DIRECCION", "COLUMNA DE DIRECCION"],
    "CINTAS": ["CINTA"],
    ...
    "ENGRASE": [
        ...
        "PISTOLA ENGRASE",
        "PISTOLA DE ENGRASE",
        "BOMBA NEUMATICA ENGRASE",
        "ADAPTADOR ENGRASE",
    ],
    "BOCALLAVES": ["BOCALLAVE"],
    "BIELAS": ["BIELA"],
    "BIELETAS": ["BIELETA"],
    "BATERIAS": ["BATERIA"],
    "BANANAS": ["BANANA"],
    ...
    "ALTERNADOR": [
        ...
        "BASE ALTERNADOR",
        "BUJE ALTERNADOR",
        "BUJE PARA ALTERNADOR",
        "POLEA ALTERNADOR",
        "SOPORTE ALTERNADOR",
    ],
    "ADAPTADORES": ["ADAPTADOR"],
    "INYECTORES": ["INYECTOR", "INYECCION"],
    "INSERTOS": ["INSERTO"],
    "SERVICIOS": [
        "INSTALACION",
        "REPARACION",
    ...
    "ELECTROVALVULAS": ["ELECTROVALVULA"],
    "RULEMANES": ["RULEMAN", "RODAMIENTO"],
    "RUEDAS": ["RUEDA"],
    "RODILLOS": ["RODILLO"],
    "RESORTES": ["RESORTE", "RESOTE"],
    "PULMONES": ["PULMON"],
    "PULIDORAS": ["PULIDORA"],
    "PORTONES": ["PORTON"],
    "TCM": ["TCM"],
    ...
    "TANQUES": ["TANQUE"],
    "TACHAS": ["TACHA"],
    "SUPLEMENTOS": ["SUPLEMENTO", "SUPLEM."],
    "SURTIDORES": ["SURTIDOR"],
    "SUNCHOS": ["SUNCHO"],
    "SUBCONJUNTOS": ["SUBCONJUNTO", "SUBCONJ"],
    "SOLENOIDES": [],
    "SINCRONIZADOS": ["SINCRONIZADO"],
    "SILENCIADORES": ["SILENCIADOR"],
    "SERPENTINAS": ["SERPENTINA"],
    "SEPARADORES": ["SEPARADOR"],
    "SENSORES": ["SENSOR", "SENSON"],
    "SELECTORAS": ["SELECTORA"],
    "SEGUROS": ["SEGURO"],
    "SATELITES": ["SATELITE"],
    "SALIDAS DE ESCAPE": ["SALIDA"],
    "INDUMENTARIA": [
        "REMERA",
        "CAMISA",
        "PANTALON",
    ...
    "PURGADORES": ["PURGADOR"],
    "PUNTERAS": ["PUNTERA"],
    "PUNTAS DESTORNILLADOR": ["PUNTA DESTORNILLADOR", "PUNTA TORX", "PUNTA EXAG"],
    "PUNTAS DE EJE": ["PUNTA EJE", "PUNTA DE EJE"],
    "PUNTAS TORCHA": ["PUNTA TORCHA"],
    "PUNTAS SOLDADOR": ["PUNTA LAPIZ", "PUNTA SOLD"],
    "ACRILICOS": ["ACRILICO"],
    "ALARGUES": ["ALARGUE"],
    ...
    "BURROS DE ARRANQUE": [
        ...
        "SOLENOIDE",
        "SELENOIDE",
        "PORTA CARBONES ARRAN",
        "BUJE ARRANQUE",
        "BULON BURRO",
        "BULON MOTOR ARRANQUE",
        "CORONA ARRANQUE",
        "CORONA DE ARRANQUE",
        ...
        "EJE DE BURRO",
        "ENGRANAJE PLANET ARRANQUE",
        "PIÐON ARRANQUE",
        "PIÐON BURRO ARRANQUE",
        "PISTON ARRANQUE",
        "PLANETARIO ARRANQUE",
        "RELAY ARRANQUE",
        "PORTACARBONES ARRANQUE",
        "TAPA ARRANQUE",
        "TAPA CON CARBONES ARRANQUE",
        "SEGURO BENDIX ARRANQUE",
        "KIT SEGURO ARRANQUE",
        "IMPULSOR DE ARRANQUE",
    ],
    "CABLES": ["CABLE", "SPAGHETTI CABLE", "CHICOTE", "CHICOTES", "CHCOTE"],
    "CALIPERS": ["CALIPER"],
    "CAMPANAS": ["CAMPANA", "CAMPANITA"],
    "TURBOS": ["TURBO"],
    "PERNOS": ["PERNO"],
    "O'RINGS": [
        "O┤RING",
    ...
    "MOTORES DESEMPAÑADORES": ["MOTOR DESEMPAÐADOR", "MOTOR DESEMPAÑADOR"],
    "BITURBOS": ["MOTOR EVAPORADOR BITURBO", "MOTOR EVAP BITURBO", "BITURBO"],
    "MAZAS DE RUEDA": ["MAZA RUEDA"],
    "MANGUERAS": ["MANGUERA"],
    "MANIJAS": ["MANIJA"],
    "GOBERNADORES": [
        "GOBERNADOR",
    ...
    "FUSIBLES": ["FUSIBLE", "FUSIBLERA"],
    "FUELLES": ["FUELLE"],
    "ENTRETAPAS": ["ENTRETAPA"],
    "ENTRERROSCAS": ["ENTRERROSCA", "ENTREROSCAS"],
    "ELECTROVENTILADORES": ["ELECTROVENTILADOR"],
    "EJES": ["EJE"],
    "ECM": ["ECM"],
    "ECU": ["ECU"],
    "DIFERENCIALES": ["DIFERENCIAL"],
    "DIAFRAGMAS": ["DIAFRAGMA"],
    "CUBIERTAS": ["CUBIERTA"],
    "CRIQUETS": ["CRIQUE", "CRIQUET"],
    "CORREAS": ["CORREA"],
    "COMPRESORES": ["COMPRESOR"],
    "COJINETES": ["COJINETE", "COJIN", "COJINETES"],
    "CODOS": ["CODO"],
    "CIGUEÑALES": ["CIGUEÐAL", "CIGUEÑAL", "CIG▄ENAL", "CIG▄EÐAL"],
    "CARTERS": ["CARTER"],
    "CARDANS": ["CARDAN"],
    "CARCAZAS": ["CARCAZA"],
    "BRAZOS ESPEJO": ["BRAZO ESPEJO"],
    "BLOCKS MOTORES": ["BLOCK MOTOR"],
    "AUTOMATICOS": [],
    "APAREJOS": ["APAREJO"],
    "ACOPLES": ["ACOPLE"],
    "ANILLOS": ["ANILLO"],
    "ANTENAS": ["ANTENA"],
    "APOYOS": ["APOYA", "APOYO"],
    "ARBOLES DE LEVAS": ["ARBOL DE LEVAS"],
    "AROS": ["ARO", "AROS"],
    "ARNESES": ["ARNES"],
    "ASIENTOS": ["ASIENTO"],
    "BARRAS DE DIRECCION": ["BARRA DIR", "BARRA CORTA DIRECCION", "BARRA CORTA DIRECC"],
    "BISAGRAS": ["BISAGRA"],
    "": [""],
    "": [""],
    "": [""],
